//thống kê tổng user trong hệ thống
const ds_tk = JSON.parse(localStorage.getItem("ds_tk") || "[]");
const tongUser = ds_tk.length;
...
//thống kê bài public
const baiPublic = noidungList.filter(item => item.role.toLowerCase() === "công khai" || item.role.toLowerCase() === "public").length;
